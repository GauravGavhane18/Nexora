...
import { FiEye, FiEyeOff, FiShoppingBag, FiMail, FiLock, FiTrendingUp } from 'react-icons/fi'
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.user.role !== 'seller') {
        toast.error('This login is for sellers only. Please use the customer login.')
        return
      }
      
      if (!result.user.sellerProfile?.isApproved) {
        toast.info('Your seller account is pending approval. You can still access your dashboard.')
      } else {
      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <div className="mt-6 flex items-center justify-center">
            <FiShoppingBag className="h-8 w-8 text-green-600 mr-2" />
        ...
        <div className="bg-white rounded-lg shadow-xl p-8">
          <div className="mb-6 p-4 bg-green-50 rounded-lg border border-green-200">
            ...
            <ul className="mt-2 text-xs text-green-700 space-y-1">
              ...
              <li>• Access seller tools and resources</li>
            </ul>
          </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="mt-6 border-t border-gray-200 pt-6">
              <div className="text-center">
                <p className="text-sm text-gray-500 mb-3">Looking to shop?</p>
                <Link
                  to="/auth/buyer/login"
